...
export const all_products_page = (title)=>({title,type:ALL_PRODUCTS_PAGE})
export const cart_page = (title)=>({title,type:CART_PAGE})
export const add_product_page = (title)=>({title,type:ADD_PRODUCT_PAGE})
export const item_details_page = (title)=>({title,type:ITEM_DETAILS_PAGE})
